const dumyData = [
  {
    id: 28,
    url: 'https://www.tvmaze.com/episodes/28/person-of-interest-1x01-pilot',
    name: 'Pilot',
    season: 1,
    number: 1,
    type: 'regular',
    ...
    runtime: 60,
    image: {
      medium: 'https://static.tvmaze.com/uploads/images/medium_landscape/35/89344.jpg',
      original: 'https://static.tvmaze.com/uploads/images/original_untouched/35/89344.jpg',
    },
    ...
    _links: {
      self: {
        href: 'https://api.tvmaze.com/episodes/28',
      },
    },
  },
  {
    id: 29,
    url: 'https://www.tvmaze.com/episodes/29/person-of-interest-1x02-ghosts',
    name: 'Ghosts',
    season: 1,
    number: 2,
    type: 'regular',
  ...
  },
  {
    ...
    airdate: '2011-10-13',
    airtime: '21:00',
    airstamp: '2011-10-14T01:00:00+00:00',
    runtime: 60,
    image: {
      medium: 'https://static.tvmaze.com/uploads/images/medium_landscape/35/89367.jpg',
      original: 'https://static.tvmaze.com/uploads/images/original_untouched/35/89367.jpg',
    },
    summary: "<p>Reese and Finch surveil their latest POI, Dr. Megan Tillman, while she's on call and after hours to unravel the threat surrounding the promising young physician.</p>",
    _links: {
      self: {
        href: 'https://api.tvmaze.com/episodes/31',
      },
    },
  },
  {
    id: 32,
    url: 'https://www.tvmaze.com/episodes/32/person-of-interest-1x05-judgement',
    name: 'Judgement',
    season: 1,
    number: 5,
    type: 'regular',
    airdate: '2011-10-20',
    airtime: '21:00',
    airstamp: '2011-10-21T01:00:00+00:00',
    runtime: 60,
    image: {
      medium: 'https://static.tvmaze.com/uploads/images/medium_landscape/35/89368.jpg',
      original: 'https://static.tvmaze.com/uploads/images/original_untouched/35/89368.jpg',
    },
    summary: '<p>When the Machine produces the social security number of a judge renowned for his tough sentencing, Reese and Finch have the added challenge of investigating a POI who wants nothing to do with their brand of vigilante justice.</p>',
    _links: {
      self: {
        href: 'https://api.tvmaze.com/episodes/32',
      },
    },
  },
];
const fetchCount = async () => Promise.resolve(dumyData).then((data) => data.length);
